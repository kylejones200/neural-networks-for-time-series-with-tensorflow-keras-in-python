...
class _LSTMForecaster(nn.Module):
    """LSTM forecaster (PyTorch replacement for Keras Sequential)."""
...
def build_lstm_model(input_shape: tuple[int, int], units: int = 50) -> _LSTMForecaster:
    """Build LSTM model for time series forecasting."""
    return _LSTMForecaster(n_features=input_shape[-1], hidden=units, output_size=1)
